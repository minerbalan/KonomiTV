        ...
        <div class="navigation-container elevation-8" :class="{'navigation-container--icon-only': iconOnly}">
            <nav class="navigation" :class="{'navigation--icon-only': iconOnly}">
                <div class="navigation-scroll" :class="{'navigation-scroll--icon-only': iconOnly}">
                    ...
                    <router-link v-ripple class="navigation__link" active-class="navigation__link--active" to="/fork/videos/timetable"
                                 :class="{
                            'navigation__link--active': $route.path.startsWith('/fork/videos/timetable'),
                            'navigation__link--icon-only': iconOnly,
                        }">
                        <Icon class="navigation__link-icon" icon="fluent:calendar-clock-20-regular" width="26px" />
                        <span v-if="!iconOnly" class="navigation__link-text">録画番組表(fork)</span>
                    </router-link>
